                        ...
                        <tr key={data.categoryId}>
                            ...
                            <td>
                                <Link to={`/blog/category/update/${data.categoryId}`}>
                                    <i onClick={() => setUpdateBlogCategory(data)} className="fa-solid fa-pen-to-square"></i>
                                </Link>
                            </td>
                            <td>
                            ...
                            <td>
                                <Link>
                                    <i onClick={() => setDeleteBlogCategory(data.categoryId)} className="fa-solid fa-trash-can text-danger"></i>
                                </Link>
                            </td>
                        </tr>
                    )
